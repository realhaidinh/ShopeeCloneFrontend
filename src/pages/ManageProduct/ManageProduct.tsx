...
import { Table, Button, Card, Spin, Empty, Modal, Image, Typography, Space, Tooltip, Badge, Input } from 'antd'
...
import { Brand, Category, Product, ProductListConfig, Sku } from 'src/types/product.type'
import productApi from 'src/apis/product.api'
import { AppContext } from 'src/contexts/app.context'
import { orderBy, sortBy, SortBy } from 'src/constants/product'
      ...
      render: (_: any, record: Product) => (
        <Space>
          <Tooltip title='View Details'>
            <Button shape='circle' icon={<EyeOutlined />} onClick={() => handleViewProduct(record.id)} />
          </Tooltip>
